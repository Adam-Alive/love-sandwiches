...
'''
The next two functions have been refactored using the function
update_worksheet(data, worksheet).
# New function with data as a parameter.
...
# This function replaces (has refactored) the two functions above
